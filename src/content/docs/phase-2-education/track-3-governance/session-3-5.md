...
The fifth Track 3 session maps the federal and state AI regulation landscape onto the agency's actual operations. The output is a practical compliance matrix: what laws apply, what deadlines they impose, what the agency owes in disclosures and assessments, and who owns the response.
...
Same Track 3 audience plus the agency's compliance officer or designee. General Counsel attendance strongly recommended. Sessions 3.1–3.4 should be complete.

## Pre-work

- Read the [Legislative Compliance](/phase-1-governance/legislative-compliance/) page in full.
- Compliance officer brings a list of jurisdictions where the agency operates or holds data (relevant for residency requirements).
- Counsel brings any pending state-law analyses already in flight.
...
### Block A — Identify in-scope laws (20 min)

The room walks through the candidate list. For each:

- **Does this apply to us?** Specifically: what entities are in scope (state agencies only, or also local; private sector or public sector or both), what data is in scope (residents of the state, or any data processed in the state), what AI systems are in scope (high-risk only, or all, or specific sector).
- **Effective date and grace period.** Many laws have phased compliance. Capture both the effective date and the operational deadline.
- **Owner.** Who at the agency tracks compliance for this law? Compliance officer, legal, AI program lead, or shared.

Build the compliance matrix as the room works. Each row is a law; columns are: applies?, effective date, deadline, owner, current status, next step.

### Block B — Map laws to use cases (20 min)

Cross-reference the compliance matrix against the [risk classification](/phase-1-governance/risk-classification/) and known agency use cases. For each Tier-2 and Tier-3 use case the agency operates or plans to operate:

- Which laws govern it?
- What disclosures are required?
- What impact assessments must be filed and on what schedule?
- What contestation pathway must exist?
- What records-retention obligations apply?

The output is a use-case-by-law cross-tab that the Review Committee uses when reviewing each Tier-2 and Tier-3 case.
...
Decide how the matrix gets updated. Recommended rhythm:
...
The facilitator reads back the matrix and the prioritized action items. The output is:

- A clean v0.1 of the agency's compliance matrix.
- Prioritized action items with named owners.
- The monitoring rhythm.
- A target date for ratification by the AI Review Committee (typically the next standing meeting).
...
Session 3.5 is the last Track 3 working session. By the end, the agency has:

- A ratified 3-tier risk matrix (Session 3.1)
- A draft AUP ready for legal review (Session 3.2)
- A draft Review Committee charter (Session 3.3)
