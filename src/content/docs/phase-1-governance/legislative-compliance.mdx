...
| -------------------------------------------- | ----------------------------------- | ------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------- |
| **OMB M-25-21** (Governance, Innovation, RM) | In force (April 2025; supersedes M-24-10) | Federal agencies; flowed-down to federally-funded state and local programs     | Designate Chief AI Officer; maintain AI use-case inventory; impact assessment for high-impact AI | [Risk Classification](/phase-1-governance/risk-classification/), Use Case Inventory   |
| **OMB M-25-22** (AI Acquisition)             | In force (April 2025; supersedes M-24-18) | Federal AI procurement; pass-through to federally-funded acquisitions          | Specific contract clauses (data non-use, model disclosure, decision logs, foreign-adversary exclusion)  | [Procurement Guardrails](/phase-1-governance/procurement-guardrails/)                 |
...
| --------------------------------------- | ----------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------- |
| **Use-case inventory**                  | OMB M-25-21 (formerly M-24-10), Maryland HB 1271, Connecticut SB 1103, Washington SB 5152 | Use Case Inventory (this phase)                                                                   |
