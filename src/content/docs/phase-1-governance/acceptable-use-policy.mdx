...
The AI Acceptable Use Policy (AUP) is the plain-language policy staff, contractors, and leaders can rely on before they use AI for agency work. Without it, the agency has a weak answer when someone asks who approved a tool, what data was allowed, or what review was expected.

> **Use this as model language.** An AUP is a core Phase 1 control, but this exact template is not the only acceptable form. Keep it short, adapt the placeholders, and have counsel review the parts that cite state law, discipline, records, procurement, or regulated data.

This page provides:

1. The narrative for **why** an AUP is one of the first Phase 1 artifacts and what it should and shouldn't contain.
...
| --- | --- | --- |
| Small / no IT department | Adopt the model AUP with one named owner, one approved-tools list, and a simple rule: no sensitive data in unapproved AI tools | Ask shared counsel to review the applicable-law, discipline, records, and procurement references |
| Medium | Add role-specific training, a committee-maintained approved-tools list, and a lightweight annual review | Tie tool approval to procurement and identity/access controls |
| Large | Localize by data class, department, union/personnel rules, public notice rules, and records schedules | Add formal exception handling, annual attestations, and policy-change workflow |

## What an AUP should do

A government AUP, at minimum, should:
...
- **Establish tier-based rules** that map to your [risk classification](/phase-1-governance/risk-classification/), defining what staff can do under each tier
- **Prohibit specific high-risk practices** (entering PII into public consumer chatbots, using AI to make uncontested rights determinations, or deploying models barred by applicable sanctions, export-control, grant, or state procurement rules)
...
4. **Enforcement and references:** review committee name, sanctions/entity-list/procurement reference, personnel policy reference
...
5. **Comply with applicable law**, including `{{Applicable State AI Law}}`, the Texas Public Information Act / equivalent open-records statute, and federal AI requirements where they apply.
...
The `{{AI Review Committee}}` may escalate a use case to a higher tier based on local law, data sensitivity, public impact, or operational risk.
...
- Deploying AI from vendors, sub-processors, models, or jurisdictions barred by `{{Applicable Sanctions / Entity List / Procurement Reference}}`
...
- OMB M-25-21 (April 2025; supersedes M-24-10) and OMB M-25-22 (April 2025; supersedes M-24-18) as federal reference models where applicable
