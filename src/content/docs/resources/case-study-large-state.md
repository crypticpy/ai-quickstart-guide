...
- **Designated an Agency AI Official** per [OMB M-24-10](/resources/frameworks-cited/) before the federal mandate technically applied to a state agency, because the statewide AI Act adopted similar language.
- **Adopted a four-tier risk classification** instead of the playbook's three tiers, splitting Tier 3 into "Tier 3 — high impact" and "Tier 4 — prohibited absent specific legislative authorization." Predictive policing, individualized eligibility-denial models, and any model used to assess criminal liability landed in Tier 4 by default.
