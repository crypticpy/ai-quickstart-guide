...
description: Versioned references for the frameworks the playbook draws from — NIST AI RMF, OMB M-24-10, OMB M-25-22, SLSA, SPACE — with notes on where each is load-bearing.
sidebar:
  order: 9
---
...
- **Full title:** Advancing Governance, Innovation, and Risk Management for Agency Use of Artificial Intelligence
- **Publisher:** Office of Management and Budget, Executive Office of the President
- **Version cited:** M-24-10
- **Published:** March 2024
- **URL:** https://whitehouse.gov/wp-content/uploads/2024/03/M-24-10-Advancing-Governance-Innovation-and-Risk-Management-for-Agency-Use-of-Artificial-Intelligence.pdf

### Where it is load-bearing in the playbook

- The [Review Committee Charter](/phase-1-governance/review-committee/) maps the playbook's "Agency AI Official" role to M-24-10's required Chief AI Officer designation. This makes the same governance work satisfy both the playbook and the federal mandate (where it applies, or where a state agency adopts the federal language by reference, as the [large state case study](/resources/case-study-large-state/) did).
- The [Risk Classification](/phase-1-governance/risk-classification/) page draws its "rights-impacting" and "safety-impacting" categories directly from M-24-10's definitions, with one rename: the playbook calls them Tier 3 to keep the language consistent across all six phases.
- The public AI use case inventory required by M-24-10 corresponds to the inventory column in the playbook's risk-classification template.

### What changes when OMB updates the memorandum

M-24-10 is policy that can change with administration. The playbook's content survives changes to the _enforcement_ of M-24-10 because the underlying controls (CAIO designation, public inventory, risk management plan, contestation pathway) are also required by several state laws — see the [Legislative Tracker](/resources/legislative-tracker/). If M-24-10 is rescinded or materially weakened, no playbook content needs to be removed; the citation simply moves from "federal requirement" to "industry best practice."

## OMB Memorandum M-25-22

- **Full title:** Driving Efficient Acquisition of Artificial Intelligence in Government
- **Publisher:** Office of Management and Budget, Executive Office of the President
- **Version cited:** M-25-22
- **Published:** April 2025
- **URL:** https://whitehouse.gov/wp-content/uploads/2025/04/M-25-22.pdf

### Where it is load-bearing in the playbook

- The [Procurement Guardrails](/phase-1-governance/procurement-guardrails/) page derives its three-section addendum (A, B, C) directly from M-25-22's procurement requirements: Section A covers M-25-22's baseline obligations (data rights, vendor representations, performance reporting); Section B covers the additional obligations for "rights-impacting" or "safety-impacting" AI; Section C covers the bias-testing and audit-access provisions M-25-22 requires for the highest-risk procurements.
...
M-25-22, like M-24-10, is policy. Many of its procurement obligations are also being adopted (or are likely to be adopted) by state procurement offices using their own statutory authority. The playbook's procurement addendum stays useful even if M-25-22 is replaced, because most state-level procurement reform parallels its structure.
...
SPACE is a research framework, not a standard, so it doesn't get versioned in the formal sense. The five dimensions are stable — likely to remain the canonical framing of developer productivity for the next several years. If a successor framework emerges (DORA's research division has been extending SPACE-adjacent work), the playbook will incorporate it as a complement, not a replacement.
