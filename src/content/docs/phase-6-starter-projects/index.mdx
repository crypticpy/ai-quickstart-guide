...
**One archetype, simplified, built on pre-built frameworks.** Pick the archetype with the lowest production risk and the warmest user audience — usually a RAG Chatbot or Meeting Transcriber for an internal team that already wants the tool. Use LangChain / Semantic Kernel rather than building orchestration from scratch.

- **Pick:** RAG Chatbot or Meeting Transcriber. Both are well-bounded, low-stakes, and have strong reference implementations.
...
- **Approach:** Buy or borrow rather than build — pre-built frameworks for orchestration, a hosted vector store, off-the-shelf transcription APIs.
...
- **Production readiness:** All eight readiness criteria met before launch.
